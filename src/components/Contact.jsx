  ...
  return (
    <section id="contact" className="relative py-28 bg-black overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&q=50&auto=format&fit=crop"
          alt=""
          loading="lazy"
          decoding="async"
          width={800}
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-sky-900/5 rounded-full blur-[180px]" />
      ...
      <div className="relative w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-5">
            Contact{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-cyan-400">Us</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-start gap-4 group">
                  <div className="w-14 h-14 rounded-2xl bg-sky-500/10 border border-sky-500/10 flex items-center justify-center flex-shrink-0 group-hover:bg-sky-500/15 group-hover:border-sky-500/20 transition-colors">
                    <item.icon size={20} className="text-sky-400" />
                  </div>
                  <div>
                    <div className="text-gray-400 text-[10px] font-bold uppercase tracking-[0.2em] mb-1">{item.label}</div>
                    {item.href ? (
                      <a href={item.href} className="text-white hover:text-sky-400 transition-colors font-medium text-lg">
                        {item.value}
                      </a>
                    ) : (
            ...
            <div className="mt-10 rounded-2xl overflow-hidden border border-white/5">
              <img
                src="https://images.unsplash.com/photo-1616530940355-351fabd9524b?w=480&q=70&auto=format&fit=crop"
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-5 py-3.5 text-white placeholder-gray-600 focus:border-sky-500/40 focus:outline-none focus:shadow-[0_0_0_3px_rgba(14,165,233,0.1)] transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 rounded-xl px-5 py-3.5 text-white placeholder-gray-600 focus:border-sky-500/40 focus:outline-none focus:shadow-[0_0_0_3px_rgba(14,165,233,0.1)] transition-all resize-none"
